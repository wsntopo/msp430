...
Before you can build anything, you need to install the SimpliciTI libraries, and also the board support package for the MSP430G2553 launchpad.



((Now you need to get the board support package in the right place.  This is another set of version controlled files.))
...
In the search directory, put in the same directory you used when setting your workspace.  E.g., for me, I put in C:\Users\jmanton\work\msp430\trunk\CCS\CCS application.  Do NOT click the copy projects or automatically import referenced jprojects.  Hit Finish.
